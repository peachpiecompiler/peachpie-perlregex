...
namespace Peachpie.Library.RegularExpressions
{
    ...
    public sealed class GroupCollection : IList<Group>, IReadOnlyList<Group>, IList
    {
        ...
        private Group GetGroupImpl(int groupnum)
        {
            ...
            if (_groups == null)
            {
                ...
                for (int i = 0; i < _groups.Length; i++)
                {
                    ...
                    _groups[i] = new Group(_match.Text, _match._matches[i + 1], _match._matchcount[i + 1], groupname, i + 1);
                }
            }
